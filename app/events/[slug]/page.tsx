...
const EventDetailsPage = async ({ params }: { params: Promise<{ slug: string }> }) => {
  ...
  const {
    event: { _id, description, image, overview, date, time, location, mode, agenda, audience, tags, organizer }
  } = await request.json()
    ...
    <section id="event">
      ...
      <div className="details">
        ...
        <div className="content">
          <Image src={image} alt="Event Banner" width={800} height={900} className="max-h-114.25 w-200 rounded-lg object-cover" />

          <section className="flex-col-gap-2">
            <h2>Overview</h2>
            <p className="max-w-180">{overview}</p>
          </section>
          ...
          <section className="flex-col-gap-2">
            ...
            <p className="max-w-180">{organizer}</p>
          </section>
